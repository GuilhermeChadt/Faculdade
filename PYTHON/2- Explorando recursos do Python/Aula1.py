...
convidados_confirmados = ['Alice', 'Charlie', 'Eve']
for convidado in convidados:
    if convidado in convidados_confirmados:
        print(convidado, ": ", "confirmou sua presença.")
    else:
        print(convidado, ": ", "não está confirmado para o evento.")
